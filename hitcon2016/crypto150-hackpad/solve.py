...
from pwn import xor
print(xor('ee34773ee8e79f9475772441908b6f42f7010a867edfed92c33233b17a9730eb'.decode('hex'),'8d5706499dd985ec0c13573eeee03766'.decode('hex'),[16]*16))

for i in xrange(8+256*offset,8+256*(offset+1000),2):
...
# from pwn import *; print(xor(data,16,prev_block))
